...
Source0  : https://files.pythonhosted.org/packages/59/d6/eab966f12b33a97c78d319c38a38105b3f843cf7d79300650b7ac8c9d349/libarchive-c-5.0.tar.gz
...
%prep
%setup -q -n libarchive-c-5.0
cd %{_builddir}/libarchive-c-5.0
pushd ..
cp -a libarchive-c-5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688572103
