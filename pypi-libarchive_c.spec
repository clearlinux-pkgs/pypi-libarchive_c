...
Source0  : https://files.pythonhosted.org/packages/a0/f9/3b6cd86e683a06bc28b9c2e1d9fe0bd7215f2750fd5c85dce0df96db8eca/libarchive-c-5.1.tar.gz
...
%prep
%setup -q -n libarchive-c-5.1
cd %{_builddir}/libarchive-c-5.1
pushd ..
cp -a libarchive-c-5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709655045
