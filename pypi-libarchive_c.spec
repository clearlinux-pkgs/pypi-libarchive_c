...
Source0  : https://files.pythonhosted.org/packages/26/23/e72434d5457c24113e0c22605cbf7dd806a2561294a335047f5aa8ddc1ca/libarchive_c-5.3.tar.gz
...
%prep
%setup -q -n libarchive_c-5.3
cd %{_builddir}/libarchive_c-5.3
pushd ..
cp -a libarchive_c-5.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747922918
